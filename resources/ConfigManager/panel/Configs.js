Ext.define( 'ConfigManager.panel.Configs', {
	extend: 'Ext.Panel',
	html: '',
	header: false,
	border: false,
	...
	autoHeight: true,
	$form: null,
	formId: 'configmanager-form',
	htmlClassPrefix: "configmanager-configpanel-",
	dirty: false,
	autoScroll: true,
	oouiWidgets: {},
	...
	displayConfigs: function( records ) {
		...
		if( records.length < 1 ) {
			...
			me.body.update(
				...
				+ '<h4>'
				+ mw.message( 'configmanager-noentry' ).plain()
				+ '</h4>'
				+ '</div>'
			);
			me.resize();
	...
	resize: function() {
		...
		var height = $( $( '#configmanager-form' )[0] ).height();
